...
protected:
    ...
    void inOrderTraverse(RBTreeNode<T>*, T& a) const;
    void inOrderTraverse(RBTreeNode<T>*, vector<T>& a) const;
    void inOrderTraverse(RBTreeNode<T>*, T*& a, int& i) const;
...
public:
    ...
    void clear(){destroySubTree(root);}
    
    void inOrderTraverse(T& a) const{
        inOrderTraverse(root, a);
    }
    void inOrderTraverse(vector<T>& a) const{
        inOrderTraverse(root, a);
    }
    void inOrderTraverse(T*& a) const{
        int i = 0;
...
//     bool inOrderComp(RBTreeNode<T>*& nodePtr, RBTreeNode<T>*& nodePtr2) const{
//          bool check = true;
//         if (nodePtr == NIL && nodePtr2 == NIL){
//             check = true;
//             return check;
//         }
//         
...
//             if (nodePtr->left != NIL && nodePtr2->left != NIL){
//                 cout << "I made" << endl;
//                 inOrderComp(nodePtr->left, nodePtr2->left);
//             }
//             else {cout << "here" << endl; check = false; return check;}
//         
//             if (nodePtr->value != nodePtr2->value){
//                 check = false;
//                 return check;
//             }
//             if (nodePtr->left && nodePtr2->left)
//                 inOrderComp(nodePtr->right, nodePtr2->right);
...
template<class T>
void RBTree<T>::inOrderTraverse(RBTreeNode<T>* nodePtr, T& a) const{
    if (nodePtr != NIL){
        inOrderTraverse(nodePtr->left, a);
        a++;
        inOrderTraverse(nodePtr->right, a);
    }
}

template<class T>
void RBTree<T>::inOrderTraverse(RBTreeNode<T>* nodePtr, vector<T>& vec) const{
    if (nodePtr != NIL){
        inOrderTraverse(nodePtr->left, vec);
        vec.push_back(nodePtr->value);
        inOrderTraverse(nodePtr->right, vec);
    }
}

template<class T>
void RBTree<T>::inOrderTraverse(RBTreeNode<T>* nodePtr, T*& arr, int& i) const{
    if (nodePtr != NIL){
        inOrderTraverse(nodePtr->left, arr, i);
        arr[i++] = nodePtr->value;
        inOrderTraverse(nodePtr->right, arr, i);
     }
}
